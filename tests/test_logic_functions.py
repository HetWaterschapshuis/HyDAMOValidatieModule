...
def test_LE():
    ...
    result = logic_functions.LE(_gdf,
                                left="kruinbreedte",
                                right=3).to_list()
...
def test_LT():
    ...
    result = logic_functions.LT(_gdf,
                                left="kruinbreedte",
                                right=3).to_list()
    assert result == expected_result
...
def test_GE():
    ...
    result = logic_functions.GE(_gdf,
                                left="kruinbreedte",
                                right=3).to_list()
    assert result == expected_result
...
def test_GT():
    ...
    result = logic_functions.GT(_gdf,
                                left="kruinbreedte",
                                right=3).to_list()
    assert result == expected_result
...
def test_EQ():
    ...
    result = logic_functions.EQ(_gdf,
                                left="kruinbreedte",
                                right=3).to_list()
    assert result == expected_result
...
def test_BE():
    _gdf = gdf.loc[gdf["kruinbreedte"].notna()].copy()
    expected_result = [False, False, True]
    result = logic_functions.BE(_gdf,
                                parameter="kruinbreedte",
                                min=0.1,
                                max=3.2).to_list()
    assert result == expected_result
...
def test_ISIN():
    ...
    expected_result = [True, False, True]
    result = logic_functions.ISIN(_gdf,
                                  parameter="soortstuw",
                                  array=["overlaat"]).to_list()
    assert result == expected_result
...
def test_NOTIN():
    _gdf = gdf.loc[gdf["soortstuw"].notna()].copy()
    expected_result = [False, True, False]
    result = logic_functions.NOTIN(_gdf,
                                   parameter="soortstuw",
                                   array=["overlaat"]).to_list()
    assert result == expected_result
